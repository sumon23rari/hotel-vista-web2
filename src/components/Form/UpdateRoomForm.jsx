...
import {categories} from '../Categoris/categorisData';
import { DateRange } from 'react-date-range';
const UpdateRoomForm = ({passValueForm}) => {

 const [loading,handleDates,dates,roomData,setRoomData,handleSubmit,handleImage]=passValueForm;
  return (
